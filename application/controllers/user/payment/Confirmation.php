...
class Confirmation extends CI_Controller {
    ...
    public function index() {
        if(isset($_POST) && !empty($_POST) && isset($_POST['payment_package'])){
            ...
            $hashstring = $MERCHANT_KEY . '|' . $txnid . '|' . $package_amount . '|' . $package_title . '|' . $user_firstname . '|' . $user_email . '|' . $package_validity . '|' . $user_lastname . '|' . $user_gender . '|' . $user_caste . '|' . $user_mobile . '|' . $package_period . '|||||' . $SALT;
