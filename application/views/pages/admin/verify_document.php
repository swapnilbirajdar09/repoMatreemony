        ...
        <div class="container page_title" style="margin-top: 0px;margin-bottom: 0px;" >
            ...
            <div class="row x_title">
                <div class="w3-padding">
                    <h3><i class="fa fa-file"></i> Document Verification </h3>
                </div>
            </div>
                        ...
                        <thead>
                            <tr class="theme_bg">
                                ...
                                <th class="w3-center"><span>User Name</span></th>
                                    ...
                                    <th class="w3-center"><span>Document Type</span></th>
                           ...
                           <!--  <?php 
                            if($all_users!='' && $all_users['status']=='200'){
                              ...
                              <td class="w3-center">
                                 ...
                                 <span class=""> <?php echo $key['user_firstname'];?> <?php echo $key['user_lastname'];?><br><?php echo $key['user_gender']; ?></span>
                                 </td>
