...
<html lang="en">
    ...
    <body>
        ...
        <!-- MAIN WRAPPER -->
        <div class="body-wrap" ng-app="viewProfileApp" ng-controller="viewProfileAppController">
                                ...
                                <div class="profile">
                                    <div class="container">
                                        <div class="row cols-md-space cols-sm-space cols-xs-space">
                                            ...
                                            <?php if (isset($userDetails['status']) && isset($userDetails['status']) == 'error') { ?>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="sidebar sidebar-inverse sidebar--style-1 bg-base-1 z-depth-2-top">
                                                        <div class="sidebar-object mb-0">
                                                            ...
                                                            <div class="profile-details">
                                                                ...
                                                                <h3 class="heading heading-6 strong-400 profile-occupation mt-3"><?php
                                                                    if ($userDetails[0]['user_designation'] == '') {
                                                                        echo '<User Designation>';
                                                                    } else {
                                                                        echo $userDetails[0]['user_designation'];
                                                                    }
                                                                    ?></h3>
                                                                <?php
                                                                ...
                                                                if ($userDetails[0]['who_make_me_favourite'] != '') {
                                                                    $followers = json_decode($userDetails[0]['who_make_me_favourite'], TRUE);
                                                                }
                                                                ...
                                                                <?php if ($alreadyfollowed == 0) { ?>
                                                                    <div class="col-md-12 w3-margin-top w3-margin-bottom">
                                                                        <a ng-click="followUserProfile(<?php echo $userDetails[0]['user_id']; ?>);" class="btn btn-styled btn-block btn-circle btn-sm btn-base-5 w3-text-green"><i class="fa fa-heart"></i> Add to Favourite</a>
                                                                    </div>
                                                                <?php } else { ?>
                                                                    <li class="listing-hover">
                                                                        <div class="col-md-12 w3-margin-top w3-margin-bottom">
                                                                            <a ng-click="unFollowUserProfile(<?php echo $userDetails[0]['user_id']; ?>);" class="btn btn-styled btn-block btn-circle btn-sm btn-base-5 w3-text-red"><i class="fa fa-heart"></i> Favourite</a>
                                                                        </div>
                                                                    <?php } ?>
                                                                    ...
                                                                    <div class="profile-stats clearfix mt-2">
                                                                        <div class="stats-entry" style="width: 100%">
                                                                            ...
                                                                            <span class="">
                                                                                <?php if ($userDetails[0]['user_email_verified'] == '1') { ?>
                                                                    ...
                                                                    <div class="profile-stats clearfix mt-2">
                                                                        <div class="stats-entry" style="width: 100%">
                                                                            ...
                                                                            <span class="">
                                                                                <?php if ($userDetails[0]['user_mobile_verified'] == '1') { ?>
                                                                    ...
                                                                    <div class="profile-stats clearfix mt-2">
                                                                        <div class="stats-entry" style="width: 100%">
                                                                            ...
                                                                            <span class="">
                                                                                <?php if ($userDetails[0]['user_doc_verified'] == '1') { ?>
...
<script type="text/javascript">
                                ...
                                var app = angular.module("viewProfileApp", ['ngSanitize', 'angularUtils.directives.dirPagination']);
                                app.controller("viewProfileAppController", function ($scope, $http, $window) {
...
<script>$(function () {
    $.getScript("<?php echo base_url(); ?>assets/client/check/matrimonial.js");
    });</script>