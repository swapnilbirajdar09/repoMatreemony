...
<html lang="en">
    ...
    <body ng-app="viewProfileApp" ng-controller="viewProfileController">
        <style>
            body{
                ...
                <div class="st-pusher">
                    <div class="st-content">
                        <div class="st-content-inner">                                  
                            ...
                            <?php //print_r($userDetails[0]['user_id']); ?>
                                                            ...
                                                            <div class="profile-details">
                                                                ...
                                                                <?php if ($alreadyfollowed == 0) { ?>
                                                                    <div class="col-md-12 w3-margin-top w3-margin-bottom">
                                                                        <a ng-click="followUserProfile(<?php echo $userDetails[0]['user_id']; ?>);" class="btn btn-styled btn-block btn-circle btn-sm btn-base-5">
                                                                            <span id="interest_1" class="w3-text-blue"><i class="fa fa-heart"></i> Add To Favourite</span>
                                                                        </a>
                                                                    </div>
                                                                <?php } else { ?>
                                                                    <div class="col-md-12 w3-margin-top w3-margin-bottom">
                                                                        <a ng-click="unFollowUserProfile(<?php echo $userDetails[0]['user_id']; ?>);" class="btn btn-styled btn-block btn-circle btn-sm btn-base-5">
...
<script>
    $(function () {
    $.getScript("<?php echo base_url(); ?>assets/client/check/matrimonial.js"); });</script>
<script>
    var App = angular.module("viewProfileApp", ['ngSanitize']);
    App.controller("viewProfileController", function ($scope, $http, $window) {
