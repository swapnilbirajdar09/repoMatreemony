...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- THEME STYLES -->
        <link href="assets/vendor/css/layout.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                    ...
                    <div class="menu-container">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="index.html">
                                <img class="logo-img logo-img-main" src="assets/vendor/img/logo.png" alt="Asentus Logo">
                                <img class="logo-img logo-img-active" src="assets/vendor/img/logo-dark.png" alt="Asentus Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
        ...
        <!--========== SLIDER ==========-->
        <div class="col-md-12" style="height: auto; background-image: url(<?php echo base_url(); ?>assets/client/uploads/home_page/parallax_image/parallax1.jpg); background-position: center;background-repeat: no-repeat;background-size: cover;position: relative;">

            <div class="w3-col l12 w3-margin-top" >
                <form id="register_userForm" class="w3-black" style=" background-color:transparent !important; border:none !important; padding: 20px 40px 20px 40px">
                    <div class="container">                       
                        <div class="col-md-5 col-md-offset-7" style=" margin-top: 70px;">

                            <div class="form-group">
                                <label for="" class="w3-large">Gender :</label>
                            ...
                            <div class="form-group">
                                <label for="" class="w3-large" >Var/ Vadhu's Name :</label>
                                <input type="text" required placeholder="Enter your full name here *" name="memberName" id="id_memberName" class="w3-input">
                            </div>

                            <div class="form-group">
                                <label for="" class="w3-large" >Email :</label>
                                <label for="id_email" style="width: 100%;">
                                    <input type="email" placeholder="Enter your Email ID here *" name="emailId" id="id_email" class="w3-input" >
                                </label>
                            </div>

                            <div class="form-group">
                                <label for="" class="w3-large" >Caste :</label>
                                <label for="id_location" style="width: 100%;">
                                    <select class="w3-input" id="" name="">
                            ...
                            <div class="form-group">
                                <div class="w3-col l4 s5">
                                    <label for="" class="w3-large" >Mobile code :</label>
                                ...
                                <div class="w3-col l8 s7" style="padding-left: 8px">
                                    ...
                                    <label style="width: 100%;">
                                        <input type="number" class="w3-input" id="id_mobileNumber" placeholder="Mobile Number here *">
                                    </label>
                                </div>
                            </div>
                            <div class="w3-col l12">
                                ...
                                <button type="submit" class="btn btn-block w3-text-black registerbtn" style="background-color: #5E32E1">Register</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content-lg container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="assets/vendor/img/970x647/01.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="assets/vendor/img/970x647/02.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="assets/vendor/img/970x647/03.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="swiper-slider swiper-clients">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/01.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/02.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/03.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/04.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/05.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="assets/vendor/img/clients/06.png" alt="Clients Logo">
                        </div>
                    </div>
                    <!-- End Swiper Wrapper -->
                </div>
        ...
        <div class="promo-section overflow-h">
            ...
            <div class="promo-section-img-right">
                <img class="img-responsive" src="assets/vendor/img/970x970/01.jpg" alt="Content Image">
            </div>
        </div>
        <!-- End Promo Section -->
                ...
                <div class="masonry-grid">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="assets/vendor/img/800x400/01.jpg" alt="Portfolio Image">
                            </div>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="assets/vendor/img/397x400/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="assets/vendor/img/397x300/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="assets/vendor/img/397x300/02.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".5s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="assets/vendor/img/397x300/03.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
        ...
        <footer class="footer">
            ...
            <div class="content container">
                <div class="row">
                    <div class="col-xs-6">
                        <img class="footer-logo" src="assets/vendor/img/logo.png" alt="Asentus Logo">
                    </div>
        ...
        <!-- PAGE LEVEL SCRIPTS -->
        <script src="assets/vendor/js/layout.min.js" type="text/javascript"></script>
        <script src="assets/vendor/js/components/wow.min.js" type="text/javascript"></script>
        <script src="assets/vendor/js/components/swiper.min.js" type="text/javascript"></script>
        <script src="assets/vendor/js/components/masonry.min.js" type="text/javascript"></script>
