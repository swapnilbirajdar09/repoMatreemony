    			...
    			<div class="col-xs-12 col-md-4">
    				...
    				<div class="subscribe-form" id="loginDiv" style="padding:20px;display: none;">
    					...
    					<form>
    						<div class="w3-col l12 w3-margin-bottom">
    							<label class="w3-large">Email ID : </label>
    							<input type="email" name="login_email_id" class="w3-input control w3-text-grey" placeholder="Enter your email*" required id="login_mc-email">
    						</div>
    						<div class="w3-col l12 w3-margin-bottom">
    							<label class="w3-large">Password : </label>
    							<input type="email" name="login_password" class="w3-input control w3-text-grey" placeholder="Enter your password*" required id="login_mc-password">
    						</div>
    						<div class="w3-col l12 text-center w3-margin-bottom">
    							<div class="space-20"></div>
    							<button class="bttn-default btn btn-block" type="submit" style="border-radius: 5px; background: linear-gradient(45deg, rgba(72, 44, 191, 1) 0%, rgba(106, 198, 240, 1) 100%);"><i class="fa fa-lock"></i> Log In</button>
    						</div>
    					</form>
    				</div>
    			</div>
